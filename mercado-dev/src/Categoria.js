...
class Categoria extends Component{
    ...
    loadAnuncios(urlCategoria){
        ...
        const url = `https://mercado-dev-adb83.firebaseio.com/anuncios.json?orderBy=%22categoria%22&equalTo=%22${urlCategoria}%22`
        ...
        return (
            <div>
                ...
                { Object.keys(this.state.anuncios).map( key => { 
                    ...
                    return <AnunciosHome key={key}  id={key} anuncio={anuncio}/> 
                })}
                </div>
            </div> 
